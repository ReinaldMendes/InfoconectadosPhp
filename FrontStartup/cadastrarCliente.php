...
<!-- Container principal -->
<div class="container">
    <h1 class="jumbotron-heading">Bem-vindo ao Cadastro de Clientes</h1>
...
<form method="POST" action="cadastrarClienteSubmit.php">
    ...
    <div class="form-group row">
        <label for="qualServicoNecessita" class="col-sm-2 col-form-label"><h5>Qual Serviço Necessita: </h5></label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="qualServicoNecessita" placeholder="Qual Serviço Necessita" required>
        </div>
    </div>
    <div class="form-group row">
